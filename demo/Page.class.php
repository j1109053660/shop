        ...
        public function pageBar($mode=1)
        {
                ...
                switch ($mode)
                {
                        ...
                        case '2':
                                ...
                                $this->first_page='首页';
                                $this->last_page='尾页';
                                return $this->first_page().$this->pre_page().'[第'.$this->current_pageno.'页]'.$this->next_page().$this->last_page();
                                break;
                        case '3':
                                $this->next_page='下一页';
                                $this->pre_page='上一页';
                        ...
                        case '5':
                                ...
                                return $strpage.$this->first_page().$this->pre_page().'[第'.$this->current_pageno.'页]'.$this->next_page().$this->last_page();
                                break;
